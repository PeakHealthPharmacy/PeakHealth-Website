...
(function () {
    var searchIndex = [
        ...
        { title: 'Health Screenings',               url: 'health-screenings',            icon: 'fa-microscope',     keywords: ['health screening', 'screening', 'health test', 'blood test', 'cholesterol', 'diabetes', 'test kit', 'check', 'hba1c', 'blood pressure', 'bp check'] },
        ...
        { title: 'Blood Pressure',                  url: 'health-screenings',            icon: 'fa-heart',          keywords: ['blood pressure', 'hypertension', 'bp', 'bp check', 'systolic', 'high blood pressure'] },
